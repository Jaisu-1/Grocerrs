...
module.exports =(req,res)=>{
    ...
    if(search=="All" && brand=="All" && category=="All" && minPrice=="All" && maxPrice=="All")
    {   Item.find({$and:[{available:true},{totalQuantity:{ $gt: 0 }}]},(err,items)=>{
            if(err)
            {
    ...
    {
        Item.find({$and:[{available:true},{totalQuantity:{ $gt: 0 }}]
           },(err,items)=>
           {
